...
- I moderatori possono sospendere e ripristinare gli account non amministrativi. La sospensione revoca subito l’accesso ai dati applicativi anche con un token ancora valido; entrambe le azioni entrano nel registro append-only. Un moderatore non può sospendere sé stesso o un altro moderatore da questa interfaccia.
