...
- **2FA e sessioni:** TOTP facoltativa per tutti e consigliata ai moderatori. Attivazione, verifica agli accessi successivi e disattivazione protetta da `aal2` sono implementate; resta da collaudare su Supabase cloud. Rimane da aggiungere la pagina dispositivi e sessioni attive con revoca singola o di tutte tranne quella corrente. Mostrare la data dell'ultimo accesso; non raccogliere IP solo per questa funzione.
