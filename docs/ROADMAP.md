...
| Federazione                                      | Discovery WebFinger/Actor e documenti Note/Create dei post testuali pubblici sono testabili in sviluppo; resta disattivata in produzione. Firme, inbox, outbox e consegna sono ancora da implementare. |
