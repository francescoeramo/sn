...
| Federazione                                      | Discovery WebFinger/Actor testabile in sviluppo per profili pubblici; resta disattivata in produzione. Firme, inbox, outbox e traduzione attività sono ancora da implementare.                |
| Chat di gruppo                                   | Ruoli, inviti consensuali e interfaccia di gestione implementati. Formato E2EE v2 e storage con ricevute sono verificati localmente; manca la UI dei messaggi e il collaudo cloud.            |
...
| Moderazione                                      | Registro append-only implementato per note, segnalazioni e rimozioni dei post. Estenderlo ai ban con la futura gestione amministrativa degli account. Da collaudare sul cloud.                |
