...
| Federazione                                      | Opt-in separato, discovery WebFinger/Actor, outbox paginato e documenti Note/Create dei post testuali pubblici sono testabili in sviluppo; resta disattivata in produzione. Firme, inbox e consegna sono ancora da implementare. |
